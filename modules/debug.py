...
async def reload_module(ctx: lightbulb.Context):
    ...
    await ctx.respond(f"Reloaded module {module_name}")
...
async def unload_module(ctx: lightbulb.Context):
    ...
    try:
        ...
        await ctx.respond(f"Couldn't unload module {module_name}")
        return
...
async def load_module(ctx: lightbulb.Context):
    ...
    try:
        ...
        await ctx.respond(f"Can't find module {module_name}")
        return
